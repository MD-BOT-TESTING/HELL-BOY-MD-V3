...
│          (")_(")
└─「 ʙᴏᴛ ɪɴғʀᴏᴍᴀᴛɪᴏɴ 」       
│❏ ѕᴩᴇᴇᴅ : ${latensie.toFixed(4)} miliseconds
│❏ ʀᴜɴᴛɪᴍᴇ : ${runtime(process.uptime())}
│❏ ʙᴏᴛ ɴᴀᴍᴇ : ${global.botname} ≧◡≦
│❏ ᴏᴡɴᴇʀ ɴᴀᴍᴇ : ${global.ownername}
│❏ ᴏᴡɴᴇʀ ɴᴜᴍʙᴇʀ : ${global.ownernummenu}
│❏ ᴩʟᴀᴛғʀᴏᴍ : ${os.platform()}
│❏ ᴛᴏᴛᴀʟ ᴜѕᴇʀѕ : ${Object.keys(global.db.users).length}
│❏ ᴛᴏᴛᴀʟ ʜɪᴛ : ${jumlahcmd}
...
case 'sc': case 'script': case 'donate': case 'donate': case 'cekupdate': case 'updatebot': case 'cekbot': case 'sourcecode': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
teks = `*「 ${global.botname} Script 」*\n\nYouTube: ${global.websitex}\nGitHub: ${global.botscript}\n\nᴅᴏɴᴀᴛᴇɪɴɢ ꜱɪᴛᴇ ɪꜱ ᴇʀʀᴏʀ ᴠʀᴏ ɪ ᴋᴏᴡɴ ʏᴏᴜ ᴀʀᴇ ʜᴀᴩᴩʏ ʙᴜᴛ ᴍᴇ🥲`
let buttons = [
...
title:"ꜱɪᴛᴇ ɪꜱ ᴇʀʀᴏʀ ᴠʀᴏ",
body: "ʜᴇʟʟ ʙᴏʏ", 
thumbnail: fs.readFileSync("XeonMedia/theme/cheemspic.jpg"),
mediaType:1,
mediaUrl: 'https://telegra.ph/file/f5d5229017b3fc4f6b1d2.jpg',
sourceUrl: "https://telegra.ph/file/f5d5229017b3fc4f6b1d2.jpg"
}}
}
...
*_ʙᴏᴛ ɢʀᴏᴜᴩ_*
https://chat.whatsapp.com/CoyDq2bXKMzEhS27ttAX7U`)
break
case 'getsxvdxcmd': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
     ...
     console.log(anui)
    XeonBotInc.sendMessage(from, {image:{url:anui}, caption:"ʜᴇʀᴇ ʏᴏᴜ ɢᴏ﹗"}, {quoted:m})
}
   break
  case 'whitebear':{
  	if (isBan) return reply(mess.ban)	 			
...
console.log(anu)
XeonBotInc.sendMessage(from,{image:{url:anu}, caption:"ʜᴇʀᴇ ʏᴏᴜ ɢᴏ﹗"},{quoted:m})
}
break
case 'retro':{
	if (isBan) return reply(mess.ban)	 			
...
XeonBotInc.sendMessage(from, {image:{url:teds}, caption:"ʜᴇʀᴇ ʏᴏᴜ ɢᴏ﹗"}, {quoted:m})
} else if (args[0] === 'glow') {
if (args.length < 2) return reply(`Example :\n${prefix + command + ' ' + args[0]} ${ownername}`)
...
if (!m.isGroup) return replay(mess.group)
if (!isAdmins && !isCreator) return replay(mess.admin)
let teks = `ᴛᴀɢ ᴀʟʟ ʙʏ ʜᴇʟʟ ʙᴏʏ ᴍᴅ
...
reply('ʜᴇʟʟ ʙᴏʏ ᴍᴅ ɴᴏᴡ ᴩᴜʙʟɪᴄ')
XeonBotInc.setStatus(`ʜᴇʟʟ ʙᴏʏ ᴍᴅ ᴍᴏᴅᴇ : ᴩᴜʙʟɪᴄ`)
}
break
case 'setstatuts':
case 'setbio':
...
reply('ʜᴇʟʟ ʙᴏʏ ᴍᴅ ɴᴏᴡ ᴩʀɪᴠᴀᴛᴇ')
XeonBotInc.setStatus(`ʜᴇʟʟ ʙᴏʏ ᴍᴅ ᴍᴏᴅᴇ : ᴩʀɪᴠᴀᴛᴇ`)
}
break
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
XeonBotInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `ʜᴇʟʟ ʙ͢ᴏʏ ᴍᴅ ʙʏ ʜᴇʟʟ ʙᴏʏ`}, { quoted : m })
}
break
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
			...
			break
			case 'ig2': case 'insta': case 'instagram': {
               if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
break
 ...
 reply(mess.error) 
   ...
   const xeonytiktoknowm = musim_rambutan.result.nowatermark
    XeonBotInc.sendMessage(from, { video: { url: xeonytiktoknowm }, caption: "ʜᴇʀᴇ ʏᴏᴜ ɢᴏ﹗" }, { quoted: m })
   }
  break
  case 'tiktokaudio':
case 'tiktokmusic':
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                XeonBotInc.sendMessage(m.chat, { video: { url: media.dl_link }, jpegThumbnail:buf, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `ʜᴇʀᴇ ʏᴏᴜ ɢᴏ﹗` }, { quoted: m }).catch((err) => reply(mess.error))
            }
            break
            case 'ytdl': {
            	if (isBan) return reply(mess.ban)
...
XeonBotInc.sendMessage(from, {image:{url:buffer}, caption:"ʜᴇʀᴇ ʏᴏᴜ ɢᴏ﹗"}, {quoted:m})
break
case 'ytmp32':
  case 'youtubemp32':{
  	if (isBan) return reply(mess.ban)
...
XeonBotInc.sendMessage(from, {image:{url:nye}, caption:"ʜᴇʀᴇ ʏᴏᴜ ɢᴏ﹗"}, {quoted:m})
break			
case 'xxxanjing':
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ᴏᴡɴᴇʀ 」	
╠❐ ѕᴇʟғ
╠❐ ᴘᴜʙʟɪᴄ
╠❐ ᴀɴᴛɪᴛᴀɢ
╠❐ ʀᴇɴᴛʙᴏᴛ [ᴀᴅᴅ/ᴅᴇʟ]
...
╠═══════✪「 ᴄᴏɴᴠᴇʀᴛ 」
╠❐ ᴛᴏɪᴍᴀɢᴇ [ʀᴇᴘʟʏ ѕᴛɪᴄᴋ]
╠❐ ѕᴛɪᴄᴋᴇʀ [ʀᴇᴘʟʏ ɪᴍɢ|ɢɪғ]
╠❐ ᴛᴀᴋᴇ [ʀᴇᴘʟʏ ɪᴍɢ|ɢɪғ|ѕᴛɪᴋ]
╠❐ ѕᴍᴇᴍᴇ [ʀᴇᴘʟʏ ɪᴍɢ]
╠❐ ᴇᴍᴏᴊɪᴍɪх [ᴍᴏᴊɪ+ᴍᴏᴊɪ]
╠❐ ᴇᴍᴏᴊɪ [ᴇᴍᴏᴊɪ]
╠❐ ᴛᴏᴠɪᴅᴇᴏ [ʀᴇᴘʟʏ ɪᴍɢ]
...
╠❐ ᴄɴɴ-ɴᴇᴡѕ 
╠❐ ғᴀᴊᴀʀ-ɴᴇᴡѕ 
╠❐ ғʀɪᴇɴᴅѕʜɪᴘѕʜᴏʀᴛѕᴛᴏʀʏ
╠❐ ʟᴏᴠᴇѕʜᴏʀᴛѕᴛᴏʀʏ
╠❐ ѕᴀᴄʀɪғɪᴄᴇѕʜᴏʀᴛѕᴛᴏʀʏ
╠❐ ᴅɪѕᴛᴜʀʙɪɴɢѕʜᴏʀᴛѕᴛᴏʀʏ
╠❐ ɪѕʟᴀᴍɪᴄѕʜᴏʀᴛѕᴛᴏʀʏ
╠❐ ᴄɪɴᴇᴍᴀѕᴄʜᴇᴅᴜʟᴇ
╠❐ ɴᴏᴡᴘʟᴀʏɪɴɢᴄɪɴᴇᴍᴀ
╠❐ ᴀᴍɪɴᴏ
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ɢʀᴏᴜᴩ 」	
╠❐ ɢʀᴏᴜѕᴇᴛᴛɪɴɢ
╠❐ ɢʀᴏᴜᴘʟɪɴᴋ
╠❐ ᴇᴘʜᴇᴍᴇʀᴀʟ [ᴏᴘᴛɪᴏɴ]
╠❐ ѕᴇᴛɢᴄᴘᴘ [ɪᴍᴀɢᴇ]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ᴍᴀᴋᴇʀ 」	
╠❐ ᴄᴀɴᴅʏ
╠❐ ʙʟᴀᴄᴋᴘɪɴᴋɴᴇᴏɴ
╠❐ ᴅᴇᴇᴘѕᴇᴀ
╠❐ ѕᴄɪғɪ
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ᴅᴏᴡɴʟᴏᴀᴅ 」	
╠❐ ɪɴѕᴛᴀɢʀᴀᴍ [ᴜʀʟ]
╠❐ ɪɢᴛᴠ [ᴜʀʟ]
╠❐ ɪɢѕᴛᴏʀʏ [ᴜѕᴇʀɴᴀᴍᴇ]
╠❐ ғᴀᴄᴇʙᴏᴏᴋ [ᴜʀʟ]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ѕᴇᴀʀᴄʜ」	
╠❐ ᴘʟᴀʏ [ǫᴜᴇʀʏ]
╠❐ ѕᴏɴɢ [ǫᴜᴇʀʏ]
╠❐ ʏᴛѕ [ǫᴜᴇʀʏ]
╠❐ ʟʏʀɪᴄѕ [ǫᴜᴇʀʏ]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ᴄᴏɴᴠᴇʀᴛ 」	
╠❐ ᴛᴏɪᴍᴀɢᴇ [ʀᴇᴘʟʏ ѕᴛɪᴄᴋ]
╠❐ ѕᴛɪᴄᴋᴇʀ [ʀᴇᴘʟʏ ɪᴍɢ|ɢɪғ]
╠❐ ᴛᴀᴋᴇ [ʀᴇᴘʟʏ ɪᴍɢ|ɢɪғ|ѕᴛɪᴋ]
╠❐ ѕᴍᴇᴍᴇ [ʀᴇᴘʟʏ ɪᴍɢ]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ʀᴀɴᴅᴏᴍ ɪᴍᴀɢᴇ 」	
╠❐ ᴄᴏғғᴇᴇ
╠❐ ʙᴛѕ
╠❐ ᴡᴏᴏғ
╠❐ ᴍᴇᴏᴡ
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ᴀɴɪᴍᴇ 」	
╠❐ ɴᴇᴋᴏ𝟸
╠❐ ᴡᴀɪғᴜ
╠❐ ᴡᴀɪғᴜ𝟸
╠❐ ᴀᴡᴏᴏ𝟸
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ѕᴛɪᴄᴋᴇʀ 」	
╠❐ ᴘᴀᴛʀɪᴄᴋ
╠❐ ᴇᴍᴏᴊɪ
╠❐ ᴇᴍᴏᴊɪᴍɪх
╠❐ ᴀᴛᴛᴘ
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ᴀɴɪᴍᴇ ѕᴛɪᴄᴋᴇʀ」	
╠❐ ʟᴏʟɪ
╠❐ ʙᴜʟʟʏ
╠❐ ᴄᴜᴅᴅʟᴇ
╠❐ ᴄʀʏ
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ɴѕғᴡ 」	
╠❐ ʜᴇɴᴛᴀɪᴠɪᴅᴇᴏ
╠❐ ʏᴜʀɪ
╠❐ ᴍᴀѕᴛᴜʀʙᴀᴛɪᴏɴ
╠❐ ᴛʜɪɢʜѕ
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ғᴜɴ 」	
╠❐ ʜᴏᴡ [ᴛᴇхᴛ
╠❐ ᴡʜᴇɴ [ᴛᴇхᴛ]
╠❐ ᴡʜᴇʀᴇ [ᴛᴇхᴛ]
╠❐ ɪѕ [ᴛᴇхᴛ]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ɢᴀᴍᴇ 」	
╠❐ ᴛʀᴜᴛʜ
╠❐ ᴅᴀʀᴇ
╠❐ ᴛɪᴄᴛᴀᴄᴛᴏᴇ
╠❐ ᴅᴇʟᴛᴛᴛ
...
await XeonBotInc.send5ButImg(from, `╔═══✪「 ᴀɴᴏɴʏᴍᴏᴜѕ 」	
╠❐ ᴀɴᴏɴʏᴍᴏᴜѕ
╠❐ ѕᴛᴀʀᴛ
╠❐ ɴᴇхᴛ
╠❐ ʟᴇᴀᴠᴇ
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ᴛᴏᴏʟ 」	
╠❐ ᴛʀᴀɴѕʟᴀᴛᴇ [ᴛᴇхᴛ]
╠❐ ғʟɪᴘᴛᴇхᴛ [ᴛᴇхᴛ]
╠❐ ᴛᴏʟᴇᴛᴛᴇʀ [ɴᴜᴍʙᴇʀ]
╠꒰ ͜͡➸ ⚞ʀᴇ-ᴇᴅɪᴛᴇᴅ ʙʏ ʜᴇʟʟ ʙᴏʏ⚟
...
await XeonBotInc.send5ButImg(from, `╔═══✪「 ᴅᴀᴛᴀʙᴀѕᴇ 」	
╠❐ ѕᴇᴛᴄᴍᴅ
╠❐ ʟɪѕᴛᴄᴍᴅ
╠❐ ᴅᴇʟᴄᴍᴅ
╠❐ ʟᴏᴄᴋᴄᴍᴅ
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ɪɴᴅᴏ 」	
╠❐ ᴅᴀʀᴋᴊᴏᴋᴇ
╠❐ ǫᴜᴏᴛᴇѕ
╠❐ ᴀɴɪᴍᴇǫᴜᴏᴛᴇѕ
╠❐ ᴊᴀʟᴀɴᴛɪᴋᴜѕ-ᴍᴇᴍᴇ
...
await XeonBotInc.send5ButImg(from, `╔═✪「 ɪɴᴅᴏ ʜᴏʀᴏѕᴄᴏᴩᴇ」	
╠❐ ɴᴏᴍᴏʀʜᴏᴋɪ
╠❐ ᴀʀᴛɪᴍɪᴍᴘɪ 
╠❐ ᴀʀᴛɪɴᴀᴍᴀ 
╠❐ ʀᴀᴍᴀʟᴊᴏᴅᴏʜ 
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 ᴏᴛʜᴇʀ 」	
╠❐ ᴀғᴋ
╠❐ ᴄʜᴀᴛɪɴғᴏ
╠❐ ᴀʟɪᴠᴇ
╠❐ ѕᴄʀɪᴘᴛ
